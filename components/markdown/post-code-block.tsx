...
export const PostCodeBlockMarkdownName = "pre";
export const PostCodeBlockComponentName = "PostCodeBlock";
...
const extractLanguageFromClass = (classname?: string): keyof typeof supportedLanguages|undefined => {
  if (classname){
    const classNames = classname.split(" ");
    const languageIndicator = classNames.find(item => item.startsWith("language-"));

    if (languageIndicator){
      return languageIndicator.replace("language-", "") as keyof typeof supportedLanguages;
    }
  }
